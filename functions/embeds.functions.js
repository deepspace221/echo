...
var description = "\
      ...
      \n\
      \n💠 The **v. Private** role is connected to the **Private** voice category and it's by default assigned to every member on this server.\ 
      \nTo remove it from your view you can run the command `.iamnot v. private` at <#337513163853529088>.\
      \n\
      \n💠 The **v. Recycle Bin** role is connected to the **recycle bin** category. By default it is not assigned to members on this server.\
      \nTo add it to your view run the command `.iam v. Recycle Bin` at <#337513163853529088>.\
      \n\
      \n💠 The **God Mode** role will allow you to see all the language categories (about 360 channels) irrespectively to the roles assigned to your profile. It will overwrite them. If you wish to view also sub-genre hooks you can, as an addenum to god mod, also add the **Extras** role (about 60 additional channels).\ 
      \n\
      ...
      \n\
      \n💠 You can unsubscribe from server's <#335379990424059905> by running:\
      \n```.iamnot updates```\  
";   
